...
# In the Linux instance shell, examine the file installhugo.sh by running cat /tmp/installhugo.sh. You can also see the contents below:
# Output:
...
# Now that you know what the website looks like, it's time to deploy it to Firebase. First enable Firebase within your existing project.

# Open a new tab in the browser you are using to access the Google Cloud Console, then open Firebase in it to go to the Firebase console.

# Now click Add project.

# You will be asked to select a name for your project.

# Click inside of the name field and select your existing Google Cloud project that starts with "qwiklabs-gcp-..." as shown in the figure below:
# Enter your project name field

# Check the Firebase terms.

# Check I confirm that I will use Firebase exclusively for purposes relating to my trade, business, craft, or profession. Click Continue.
...
# Finish your quest
# This self-paced lab is part of the Build Apps & Websites with Firebase quest. A quest is a series of related labs that form a learning path. Completing this quest earns you a badge to recognize your achievement. You can make your badge or badges public and link to them in your online resume or social media account. Enroll in this quest and get immediate completion credit. Refer to the Google Cloud Skills Boost catalog for all available quests.

# Take your next lab
# Continue your quest with Google Assistant: Build an Application with Dialogflow and Cloud Functions, or try one of these:
...
# Manual Last Updated March 17, 2023
