...
# This lab is recommended for students enrolled in the Detect Manufacturing Defects using Visual Inspection AI quest. Are you ready for the challenge?
...
# Connect to the Compute Engine instance called vm_name using SSH.
...
# Note: You can review the docker run commands used in the Visual Inspection deploy and test labs in the quest for the syntax that you should use to deploy the solution artifact.
...
# Detect_Manufacturing_Defects_Visual_Inspection_AI_Skill_badge

# Earn your next skill badge
# This self-paced lab is part of the Detect Manufacturing Defects using Visual Inspection AI quest. Completing this skill badge quest earns you the badge above, to recognize your achievement. Share your badge on your resume and social platforms, and announce your accomplishment using #GoogleCloudBadge.
...
# Manual Last Updated October 28, 2022

# Lab Last Tested March 22, 2022
