...
# Copied!
# Next, find a defective product from the cloud storage bucket. In the cloud console, go to Navigation menu > Cloud Storage > Browser.

# In the Cloud Storage Browser, navigate to the bucket named Bucket Name > cosmetic-test-data.
...
# Copied!
# Next, find a non-defective product from the cloud storage bucket. If you are not in Cloud Storage browser, in cloud console, go to Navigation menu (Navigation menu icon) > Cloud Storage > Browser. In the Cloud Storage Browser, navigate to the bucket named Bucket Name > cosmetic-test-data.
...
# Finish your quest
# This self-paced lab is part of the Detect Manufacturing Defects using Visual Inspection AI quest. A quest is a series of related labs that form a le)arning path. Completing this quest earns you a badge to recognize your achievement. You can make your badge or badges public and link to them in your online resume or social media account. Enroll in this quest and get immediate completion credit. Refer to the Google Cloud Skills Boost catalog for all available quests.
...
# Manual Last Updated October 27, 2022
