...
# After creating the agent, navigate to Agent Settings > General > Logging settings and click on Enable Cloud Logging and Enable Interaction Logging option. It will generate logs for this agent.
...
# Manual last updated January 09, 2023

# Lab last tested December 09, 2022
