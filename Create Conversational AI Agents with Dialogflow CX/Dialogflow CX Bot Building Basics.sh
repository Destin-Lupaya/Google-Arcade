...
# Scroll down to Initial prompt fulfillment > Agent Says and add What city would you like the flight to depart from?
# Click Save.
...
# Under Agent says type the following: Thank you for that information. Let me check on the availability of your ticket.
# Click Save.
...
# Click Save.
# After saving, scroll down to the Fulfillment section and enter Great, your flight is booked!
