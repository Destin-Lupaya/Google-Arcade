...
# Overview
# In a challenge lab, you’re given a scenario and a set of tasks. Instead of following step-by-step instructions, you use the skills learned from the labs in the quest to decide how to complete the tasks on your own! An automated scoring system (shown on this page) provides feedback on whether you have completed your tasks correctly.

# When you take a challenge lab, you are not taught Google Cloud concepts. To build the solution to the challenge presented, use skills learned from the labs in the quest this challenge lab is part of. You are expected to extend your learned skills and to change default values, but new concepts are not introduced.

# To score 100%, you must complete all tasks within the time period!

# This lab is recommended for students who have enrolled in the Manage Bigtable on Google Cloud skill badge quest. Are you ready for the challenge?
...
# Congratulations!
# In this lab, you proved your Bigtable skills by creating a new Bigtable instance, creating and populating new tables, configuring node autoscaling and replication, and backing up and restoring data in Bigtable.

# skill badge png

# Earn your next skill badge
# This self-paced lab is part of the Manage Bigtable on Google Cloud skill badge quest. Completing this skill badge quest earns you the badge above to recognize your achievement. Share your badge on your resume and social platforms, and announce your accomplishment using #GoogleCloudBadge.

# This skill badge quest is part of Google Cloud’s Database Engineer learning path. Continue your learning journey by enrolling in the Migrate MySQL Data to Cloud SQL Using Database Migration Service skill badge quest or the Manage PostgreSQL Databases on Cloud SQL skill badge quest.
