...
# Finish your quest
# This self-paced lab is part of the Baseline: Infrastructure, Google Cloud Essentials, Kubernetes in Google Cloud quest. A quest is a series of related labs that form a learning path. Completing this Quest earns you a badge to recognize your achievement. You can make your badge (or badges) public and link to them in your online resume or social media account. Enroll in a quest and get immediate completion credit if you've taken this lab. See other available quests in the Google Cloud Skill Boost catalog.
...
# Manual Last Updated April 24, 2023
# Lab Last Tested April 24, 2023
